import numpy as np
from mesh_to_sdf.mesh_to_sdf import sample_sdf_near_surface, sample_inside_surface, ComputeNormalizationParameters
from mesh_to_sdf.mesh_to_sdf.utils import scale_to_unit_sphere
import trimesh
...
def PreprocessMesh(input_name, output_name, test_sampling=True):
    ...
    points, sdf = sample_sdf_near_surface(mesh, sampling_type=sampling_type,sign_method='depth', test_sampling=test_sampling)
