...
# 导入你的模块
from model4 import PointCloudVAE
...
def get_args():
    ...
    parser.add_argument('--save_dir', type=str, default='/home/yuwenshi/B737/model_Aero/encoder_LiftCoefficientDecoder/checkpoints_4')
...
def validate(model, val_loader, device, cl_mean, cl_std):
    ...
    with torch.no_grad():
        for batch in val_loader:
            ...
            _, _, _, cl_pred_norm = model(xyz=points, query_points=None)
...
def main():
    ...
    torch.save(train_dataset.indices, os.path.join(args.save_dir, '/home/yuwenshi/B737/model_Aero/encoder_LiftCoefficientDecoder/checkpoints_4/train_indices.pt'))  #固定训练集和验证集
    torch.save(val_dataset.indices, os.path.join(args.save_dir, '/home/yuwenshi/B737/model_Aero/encoder_LiftCoefficientDecoder/checkpoints_4/val_indices.pt'))

    train_indices = torch.load(os.path.join(args.save_dir, '/home/yuwenshi/B737/model_Aero/encoder_LiftCoefficientDecoder/checkpoints_4/train_indices.pt'))
    val_indices = torch.load(os.path.join(args.save_dir, '/home/yuwenshi/B737/model_Aero/encoder_LiftCoefficientDecoder/checkpoints_4/val_indices.pt'))
    ...
    # 3. 冻结策略：锁定 Encoder 和 Triplane 分支，只训 AeroDecoder
