...
def get_args():
    ...
    parser.add_argument('--save_dir', type=str, default='checkpoints_stage2_测试900个数据_4')
...
def main():
    ...
    # ================= 🌟 核心修改 5：差分学习率 =======================
    # 气动头用正常的学习率(比如 2e-4)，已经训练好的 Encoder 用 1/10 的学习率微调(2e-5)
    lr_aero = args.lr            
    ...
    ], weight_decay=1e-4) # 将 weight_decay 提高到 1e-3 加强抗过拟合能力
    # =======================================================================
