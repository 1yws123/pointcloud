...
def get_args():
    ...
    parser.add_argument('--save_dir', type=str, default='/home/yuwenshi/B737/model_Aero/encoder_SimpleAeroDecoder/checkpoints_2.2')
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        for i, batch in enumerate(train_loader):
            ...
            # 2. 引入极微小的高斯噪声 (模拟制造公差/表面粗糙度)
            # 这里的 0.001 相当于真实飞机的毫米级微小扰动，能极大提升网络鲁棒性
            #jitter = torch.randn_like(points) * 0.0005 
